...
SRCS = App.cpp \
	ClipdingerSettings.cpp ClipItem.cpp ClipView.cpp ContextPopUp.cpp \
	EditWindow.cpp \
	FavItem.cpp FavView.cpp \
	KeyCatcher.cpp \
	MainWindow.cpp \
	ReplView.cpp ReplWindow.cpp \
	SettingsWindow.cpp
...
LOCALES = ca cs de en en_GB es fi fr fur id it nl pl pt pt_BR ro ru sv tr uk
